...
class Inline_Editing extends Widget_Base {
	...
	public function get_title() {
		return __( 'Inline Editing', 'myblogger-core' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'Title', 'myblogger-core' ),
			]
		);
		...
		$this->add_control(
			'description',
			[
				'label' => __( 'Description', 'myblogger-core' ),
				'type' => Controls_Manager::TEXTAREA,
				'default' => __( 'Description', 'myblogger-core' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'Content', 'myblogger-core' ),
			]
		);
